...
class Knob extends React.Component {
    ...
    render() {
      ...
      return (
        <div className="knob mx-24" style={kStyle} >
            
          
          <div className="ticks">
          <p className='pb-8 pr-12 text-blue-400'> {this.currentDeg*0.22 < 10 ? 0 : parseFloat(this.currentDeg*0.22).toFixed(2)} {this.props.unit} </p>
            {this.props.numTicks
